...
export default function Messages() {
  ...
  return (
    <>
        ...
        <TabContext value={value}>
          <Box sx={{ borderBottom: 1, borderColor: 'divider' }} className="d-flex align-items-center">
            ...
            <div className="ms-auto">
              ...
              <Link to={'/dashboard/company/add_message'} className=" ms-auto">
                  ...
                  {filteredMessages
                    ...
                    .map((message) => (
                      <TableRow key={message.id} hover tabIndex={-1} role="checkbox">
                        ...
                        <TableCell align="right">{message.company}</TableCell>
                        <TableCell align="right">Posted By {message.postedBy}</TableCell>
      ...
      >
        <MenuItem className="popover-item" onClick={() => navigate('/dashboard/company/view_message/1')}>
          <Iconify icon={'carbon:view'} sx={{ mr: 2 }} />
          View
        </MenuItem>
        <MenuItem className="popover-item" onClick={() => navigate('/dashboard/company/add_message/1')}>
